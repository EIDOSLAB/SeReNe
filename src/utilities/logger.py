...
def log_statistics(args, epoch, model, pruning_stat, train_performance, valid_performance, test_performance, lr,
                   top_cr, top_acc, cr_data, tb_writer):
    print_epoch_stat(epoch, pruning_stat, train_performance, valid_performance, test_performance, lr, tb_writer)
...
def print_epoch_stat(epoch, pruning_stat, train_performance, valid_performance, test_performance, lr, tb_writer):
    print("###########" + "#" * len(str(epoch)))
    ...
    tb_writer.add_scalar("Performance/Train/Top-1", train_performance[0], epoch)
    tb_writer.add_scalar("Performance/Train/Top-5", train_performance[1], epoch)
    tb_writer.add_scalar("Performance/Train/Loss", train_performance[2], epoch)
    tb_writer.add_scalar("Performance/Validation/Top-1", valid_performance[0], epoch)
    tb_writer.add_scalar("Performance/Validation/Top-5", valid_performance[1], epoch)
    tb_writer.add_scalar("Performance/Validation/Loss", valid_performance[2], epoch)
    tb_writer.add_scalar("Performance/Test/Top-1", test_performance[0], epoch)
    tb_writer.add_scalar("Performance/Test/Top-5", test_performance[1], epoch)
